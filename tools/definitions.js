...
WARNING: This executes a real on-chain transaction. Check DRY_RUN mode.`,
      parameters: {
        ...
        properties: {
          ...
          quote_mint: { type: "string", description: "Quote token mint address (from discover_pools). Pass it so bluechip pools (e.g. SOL-USDC) are correctly classified for binStep/cap rules." },
          ...
          token_age_hours: { type: "number", description: "Token/pool age in hours at deploy time (from discover_pools/get_top_candidates). Used for the fast bid-ask bonus-stage strategy override." },
